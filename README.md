...
Main python function: function `run()` in `python/notebook.py` (this file must always be defined as `python/notebook.py`)
Also, `run_voila.py` shouldn't be touched. You can use it to run directly without docker (it is the Dockerfile entry point)
